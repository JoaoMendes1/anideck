  ...
  return (
    <div className="min-h-screen bg-[#0A0714] text-[#F1EEFA] font-body flex flex-col selection:bg-[#7B5CFF] selection:text-white">
      ...
      <header className="sticky top-0 z-40 bg-[#0A0714]/90 backdrop-blur-md border-b border-[#2B2247] px-4 lg:px-8 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#A79BC9] hidden sm:block">Protótipo Funcional — Mecânica de Guilda & Duas Moedas</p>
          </div>
        </div>
      ...
      <nav className="bg-[#130F22] border-b border-[#2B2247] px-4 lg:px-8 overflow-x-auto flex items-center gap-2 py-2">
        {[
          { id: 'guild_card', label: 'Licença da Guilda (Perfil)', icon: Shield },
          { id: 'tracker', label: 'Tracker & Ledger de XP', icon: Zap },
          { id: 'ss_showcase', label: 'Radar dos SS (Showcase)', icon: Eye },
          { id: 'comments', label: 'Comentários por Afinidade', icon: MessageSquare },
          { id: 'admin_economy', label: 'Painel da Economia (Admin)', icon: Settings }
        ].map(tab => {
          const Icon = tab.icon;
      ...
      <main className="flex-1 p-4 lg:p-8 max-w-7xl mx-auto w-full">
        ...
        {activeTab === 'guild_card' && (
          <div className="space-y-8 animate-fade-in">
            {/* Context Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#130F22] border border-[#2B2247] p-5 rounded-2xl">
              <div>
                <h1 className="text-2xl font-title text-white tracking-wide flex items-center gap-2">
                  ESTRUTURA DE GUILDA — PROGRESSÃO DE AVENTUREIRO
                </h1>
                <p className="text-sm text-[#A79BC9] mt-1 max-w-2xl">
                  A mecânica central opera com <strong>duas moedas independentes</strong>: sua <em>Afinidade de Gênero</em> (quem você é através do seu acervo e histórico) e seu <em>Rank F→SS</em> (o que você faz agora, medindo ritmo e constância).
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 text-xs font-mono-code font-semibold rounded-full bg-[#181330] hover:bg-[#2B2247] text-[#3FE0F0] border border-[#3FE0F0]/40 transition flex items-center gap-2"
                  title="Simula o teste de farm: marcar 50 animes do passado aumenta afinidade, mas não o Rank XP"
                >
                  <BookOpen className="w-3.5 h-3.5" />
                  Simular Importação de Backlog (50 animes)
                </button>
              </div>
            </div>
            ...
            <div className="bg-[#130F22] border border-[#2B2247] p-5 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <h1 className="text-xl font-title text-white mt-1">
                  TRACKER COM RETORNO DECRESCENTE & LEDGER HISTÓRICO
                </h1>
                <p className="text-xs text-[#A79BC9] mt-1 max-w-2xl">
                  Cada episódio assistido registra uma linha no histórico com exatamente o que valeu naquele segundo. Se desmarcar, o valor exato é devolvido (sem XP fantasma).
                </p>
              </div>
              ...
              <div className="flex items-center gap-3 bg-[#181330] p-2.5 rounded-xl border border-[#2B2247]">
                <div className="text-left">
                  <div className="text-xs font-bold text-white">Evento XP Dobrado</div>
                  <div className="text-[10px] text-[#A79BC9]">Simular semana de lançamento</div>
                </div>
                <button
                  onClick={() => {
                ...
                >
                  {isEventActive ? 'ATIVO (2.0x)' : 'DESLIGADO'}
                </button>
              </div>
            </div>
              ...
              <div className="lg:col-span-5 bg-[#130F22] border border-[#2B2247] p-5 rounded-2xl space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-title text-base text-white">LIVRO DE REGISTRO (LEDGER)</h3>
                  </div>
                  <span className="text-[11px] font-mono-code text-[#A79BC9]">Auditoria Imutável</span>
                </div>
